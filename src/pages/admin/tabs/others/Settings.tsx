...
import { 
  Briefcase, ShoppingCart, Percent, FileText, Mail, 
  Settings as SettingsIcon, MessageCircle, ShoppingBag, 
  Star, CheckSquare 
} from 'lucide-react';
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
          ...
          <div className="p-2 space-y-1">
            {[
              ...
              { id: 'whitelabel', icon: SettingsIcon, label: 'Whitelabel Setting' },
                ...
                <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <div className="flex">
                      ...
                      <span className="bg-[#7B61FF] text-white px-3 flex items-center justify-center rounded-r-md"><SettingsIcon size={16}/></span>
                    </div>
                  </div>
                  <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <div className="w-full text-sm border-gray-200 rounded-md bg-white p-2 font-bold text-gray-700">
                        {formatCurrency(taxCalcAmount * (settingsFormData.defaultTaxRate || 0) / 100, settingsFormData)}
                    </div>
                  </div>
                </div>
              </div>
