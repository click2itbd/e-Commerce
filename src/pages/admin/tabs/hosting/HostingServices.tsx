...
import { Database, Edit, Trash2, Plus, X, Server } from 'lucide-react';

const HostingServicesTab: React.FC = () => {
  ...
  const [editingHostingService, setEditingHostingService] = useState<any>(null);
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      setHostingServices(snap.docs.map(d => ({ id: d.id, ...d.data() })));
    } catch (error) {
...
export default HostingServicesTab;
