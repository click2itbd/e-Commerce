...
import { ArrowLeftRight, Plus, X, Upload, List } from 'lucide-react';

interface ManualExpenseTabProps { transactions: any[]; transactionCategories: any[]; manualTransactionType: string; setManualTransactionType: (v: any) => void; newManualTransaction: any; setNewManualTransaction: (v: any) => void; isAddingManualTransaction: boolean; setIsAddingManualTransaction: (v: boolean) => void; handleSaveManualTransaction: (e: any) => void; setActiveTab: (v: string) => void; }

const ManualExpenseTab: React.FC<ManualExpenseTabProps> = ({ transactions, transactionCategories, manualTransactionType, setManualTransactionType, newManualTransaction, setNewManualTransaction, isAddingManualTransaction, setIsAddingManualTransaction, handleSaveManualTransaction, setActiveTab }) => {
