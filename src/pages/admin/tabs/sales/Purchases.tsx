...
import { ShoppingBag, Plus, Search, Calendar, Edit, Trash2, X, Ticket } from 'lucide-react';
...
const PurchasesTab: React.FC = () => {
  ...
  const addItemToPurchase = (product: any) => {
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
      ...
      {isCreatingPurchase && (
        <form onSubmit={handleCreatePurchase} className="p-6 bg-gray-50 border-b border-gray-100 space-y-6">
                ...
                .map(tx => (
                  <tr key={tx.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-6 py-4">
                      <span className="font-medium text-sm text-[#EF4444]">{tx.entityName}</span>
                    </td>
