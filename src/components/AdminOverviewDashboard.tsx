...
export const AdminOverviewDashboard: React.FC<AdminOverviewDashboardProps> = ({
  ...
  return (
    <div className="space-y-6">
      {/* Domain & Hosting Live Control Widget */}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-6 pt-6 border-t border-blue-800/40">
          ...
          >
            ...
            <div className="flex items-baseline gap-2 mt-2">
              <span className={`text-2xl font-black ${pendingHostingOrders.length > 0 ? 'text-amber-400' : 'text-white'}`}>
                {pendingHostingOrders.length}
              </span>
              <span className="text-[11px] text-blue-300">
                {pendingHostingOrders.length > 0 ? 'Awaiting verification' : 'All cleared'}
              </span>
            </div>
          </div>
          ...
          <div className="p-4 rounded-xl bg-white/5 border border-white/10">
            ...
            <div className="flex items-baseline gap-2 mt-2">
              <span className="text-2xl font-black text-emerald-400">
                {formatCurrency(todayHostingRevenue, settings)}
              </span>
