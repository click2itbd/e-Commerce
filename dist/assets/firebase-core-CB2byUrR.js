 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $e=new rf("@firebase/firestore");function hn(){return $e.logLevel}function b(r,...t){if($e.logLevel<=Yt.DEBUG){const e=t.map(xo);$e.debug(`Firestore (${Ln}): ${r}`,...e)}}function lt(r,...t){if($e.logLevel<=Yt.ERROR){const e=t.map(xo);$e.error(`Firestore (${Ln}): ${r}`,...e)}}function In(r,...t){if($e.logLevel<=Yt.WARN){const e=t.map(xo);$e.warn(`Firestore (${Ln}): ${r}`,...e)}}function xo(r){if(typeof r=="string")return r;try{return(function(e){return JSON.stringify(e)})(r)}catch{return r}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Rs(r,t){return[r,Rt(t)]}function wl(r,t,e){return[r,Rt(t),e]}const kf={},wn="documentMutations",Ls="remoteDocumentsV14",Mf=["prefixPath","collectionGroup","readTime","documentId"],Vs="documentKeyIndex",Of=["prefixPath","collectionGroup","documentId"],vl="collectionGroupIndex",Ff=["collectionGroup","readTime","prefixPath","documentId"],xr="remoteDocumentGlobal",ao="remoteDocumentGlobalKey",vn="targets",Al="queryTargetsIndex",Lf=["canonicalId","targetId"],An="targetDocuments",Uf=["targetId","path"],Mo="documentTargetsIndex",Bf=["path","targetId"],Us="targetGlobalKey",Ge="targetGlobal",Dr="collectionParents",qf=["collectionId","parent"],Rn="clientMetadata",jf="clientId",ri="bundles",zf="bundleId",si="namedQueries",Gf="name",Oo="indexConfiguration",Kf="indexId",uo="collectionGroupIndex",$f="collectionGroup",Er="indexState",Qf=["indexId","uid"],Rl="sequenceNumberIndex",Wf=["uid","sequenceNumber"],wr="indexEntries",Hf=["indexId","uid","arrayValue","directionalValue","orderedDocumentKey","documentKey"],Vl="documentKeyIndex",Jf=["indexId","uid","orderedDocumentKey"],ii="documentOverlays",Yf=["userId","collectionPath","documentId"],co="collectionPathOverlayIndex",Xf=["userId","collectionPath","largestBatchId"],Sl="collectionGroupOverlayIndex",Zf=["userId","collectionGroup","largestBatchId"],Fo="globals",tm="name",Pl=[Cr,Ut,wn,Fe,vn,Kr,Ge,An,Rn,xr,Dr,ri,si],em=[...Pl,ii],bl=[Cr,Ut,wn,Ls,vn,Kr,Ge,An,Rn,xr,Dr,ri,si,ii],Cl=bl,Lo=[...Cl,Oo,Er,wr],nm=Lo,xl=[...Lo,Fo],rm=xl;/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ku(r){let t=0;for(const e in r)Object.prototype.hasOwnProperty.call(r,e)&&t++;return t}function Se(r,t){for(const e in r)Object.prototype.hasOwnProperty.call(r,e)&&t(e,r[e])}function Dl(r){for(const t in r)if(Object.prototype.hasOwnProperty.call(r,t))return!1;return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xt{constructor(t){this.fields=t,t.sort(at.comparator)}static empty(){return new xt([])}unionWith(t){let e=new Z(at.comparator);for(const n of this.fields)e=e.add(n);for(const n of t)e=e.add(n);return new xt(e.toArray())}covers(t){for(const e of this.fields)if(e.isPrefixOf(t))return!0;return!1}isEqual(t){return Tn(this.fields,t.fields,((e,n)=>e.isEqual(n)))}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ci{constructor(){this._=void 0}}function Vm(r,t,e){return r instanceof Cn?(function(s,i){const a={fields:{[Ml]:{stringValue:kl},[Fl]:{timestampValue:{seconds:s.seconds,nanos:s.nanoseconds}}}};return i&&Uo(i)&&(i=oi(i)),i&&(a.fields[Ol]=i),{mapValue:a}})(e,t):r instanceof xn?ih(r,t):r instanceof Dn?oh(r,t):(function(s,i){const a=sh(s,i),u=sc(a)+sc(s.Ae);return fo(a)&&fo(s.Ae)?rh(u):Go(s.serializer,u)})(r,t)}function Sm(r,t,e){return r instanceof xn?ih(r,t):r instanceof Dn?oh(r,t):e}function sh(r,t){return r instanceof Lr?(function(n){return fo(n)||(function(i){return!!i&&"doubleValue"in i})(n)})(t)?t:{integerValue:0}:null}class Cn extends ci{}class xn extends ci{constructor(t){super(),this.elements=t}}function ih(r,t){const e=ah(t);for(const n of r.elements)e.some((s=>Jt(s,n)))||e.push(n);return{arrayValue:{values:e}}}class Dn extends ci{constructor(t){super(),this.elements=t}}function oh(r,t){let e=ah(t);for(const n of r.elements)e=e.filter((s=>!Jt(s,n)));return{arrayValue:{values:e}}}class Lr extends ci{constructor(t,e){super(),this.serializer=t,this.Ae=e}}function sc(r){return st(r.integerValue||r.doubleValue)}function ah(r){return Or(r)&&r.arrayValue.values?r.arrayValue.values.slice():[]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Vc={didRun:!1,sequenceNumbersCollected:0,targetsRemoved:0,documentsRemoved:0},Dh=41943040;class At{static withCacheSize(t){return new At(t,At.DEFAULT_COLLECTION_PERCENTILE,At.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT)}constructor(t,e,n){this.cacheSizeCollectionThreshold=t,this.percentileToCollect=e,this.maximumSequenceNumbersToCollect=n}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const wt="WebChannelConnection",mr=(r,t,e)=>{r.listen(t,(n=>{try{e(n)}catch(s){setTimeout((()=>{throw s}),0)}}))};class _n extends Dg{constructor(t){super(t),this.a_=[],this.forceLongPolling=t.forceLongPolling,this.autoDetectLongPolling=t.autoDetectLongPolling,this.useFetchStreams=t.useFetchStreams,this.longPollingOptions=t.longPollingOptions}static u_(){if(!_n.c_){const t=ll();mr(t,cl.STAT_EVENT,(e=>{e.stat===so.PROXY?b(wt,"STAT_EVENT: detected buffering proxy"):e.stat===so.NOPROXY&&b(wt,"STAT_EVENT: detected no buffering proxy")})),_n.c_=!0}}zo(t,e,n,s,i){const a=So();return new Promise(((u,l)=>{const d=new al;d.setWithCredentials(!0),d.listenOnce(ul.COMPLETE,(()=>{try{switch(d.getLastErrorCode()){case vs.NO_ERROR:const g=d.getResponseJson();b(wt,`XHR for RPC '${t}' ${a} received:`,JSON.stringify(g)),u(g);break;case vs.TIMEOUT:b(wt,`RPC '${t}' ${a} timed out`),l(new C(S.DEADLINE_EXCEEDED,"Request time out"));break;case vs.HTTP_ERROR:const T=d.getStatus();if(b(wt,`RPC '${t}' ${a} failed with status:`,T,"response text:",d.getResponseText()),T>0){let P=d.getResponseJson();Array.isArray(P)&&(P=P[0]);const D=P==null?void 0:P.error;if(D&&D.status&&D.message){const k=(function($){const j=$.toLowerCase().replace(/_/g,"-");return Object.values(S).indexOf(j)>=0?j:S.UNKNOWN})(D.status);l(new C(k,D.message))}else l(new C(S.UNKNOWN,"Server responded with status "+d.getStatus()))}else l(new C(S.UNAVAILABLE,"Connection failed."));break;default:O(9055,{l_:t,streamId:a,h_:d.getLastErrorCode(),P_:d.getLastError()})}}finally{b(wt,`RPC '${t}' ${a} completed.`)}}));const f=JSON.stringify(s);b(wt,`RPC '${t}' ${a} sending request:`,s),d.send(e,"POST",f,n,15)}))}T_(t,e,n){const s=So(),i=[this.Ko,"/","google.firestore.v1.Firestore","/",t,"/channel"],a=this.createWebChannelTransport(),u={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},l=this.longPollingOptions.timeoutSeconds;l!==void 0&&(u.longPollingTimeout=Math.round(1e3*l)),this.useFetchStreams&&(u.useFetchStreams=!0),this.Go(u.initMessageHeaders,e,n),u.encodeInitMessageHeaders=!0;const d=i.join("");b(wt,`Creating RPC '${t}' stream ${s}: ${d}`,u);const f=a.createWebChannel(d,u);this.E_(f);let g=!1,T=!1;const P=new Ng({Jo:D=>{T?b(wt,`Not sending because RPC '${t}' stream ${s} is closed:`,D):(g||(b(wt,`Opening RPC '${t}' stream ${s} transport.`),f.open(),g=!0),b(wt,`RPC '${t}' stream ${s} sending:`,D),f.send(D))},Ho:()=>f.close()});return mr(f,gr.EventType.OPEN,(()=>{T||(b(wt,`RPC '${t}' stream ${s} transport opened.`),P.i_())})),mr(f,gr.EventType.CLOSE,(()=>{T||(T=!0,b(wt,`RPC '${t}' stream ${s} transport closed`),P.o_(),this.I_(f))})),mr(f,gr.EventType.ERROR,(D=>{T||(T=!0,In(wt,`RPC '${t}' stream ${s} transport errored. Name:`,D.name,"Message:",D.message),P.o_(new C(S.UNAVAILABLE,"The operation could not be completed")))})),mr(f,gr.EventType.MESSAGE,(D=>{var k;if(!T){const M=D.data[0];L(!!M,16349);const $=M,j=($==null?void 0:$.error)||((k=$[0])==null?void 0:k.error);if(j){b(wt,`RPC '${t}' stream ${s} received error:`,j);const q=j.status;let nt=(function(I){const p=dt[I];if(p!==void 0)return dh(p)})(q),W=j.message;q==="NOT_FOUND"&&W.includes("database")&&W.includes("does not exist")&&W.includes(this.databaseId.database)&&In(`Database '${this.databaseId.database}' not found. Please check your project configuration.`),nt===void 0&&(nt=S.INTERNAL,W="Unknown error status: "+q+" with message "+j.message),T=!0,P.o_(new C(nt,W)),f.close()}else b(wt,`RPC '${t}' stream ${s} received:`,M),P.__(M)}})),_n.u_(),setTimeout((()=>{P.s_()}),0),P}terminate(){this.a_.forEach((t=>t.close())),this.a_=[]}E_(t){this.a_.push(t)}I_(t){this.a_=this.a_.filter((e=>e===t))}Go(t,e,n){super.Go(t,e,n),this.databaseInfo.apiKey&&(t["x-goog-api-key"]=this.databaseInfo.apiKey)}createWebChannelTransport(){return hl()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ro(s_,i_,"app");export{__ as a,T_ as b,c_ as c,Bp as d,A_ as e,m_ as f,I_ as g,v_ as h,l_ as i,V_ as j,h_ as k,g_ as l,R_ as o,p_ as p,d_ as q,y_ as r,E_ as s,w_ as u,f_ as w};
