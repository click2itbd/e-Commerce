import{L as om,_ as am,g as It,F as um,a as ie,b as Fl,d as cs,i as ta,p as Ol,c as Ll,e as si,f as cm,h as lm,j as ql,k as hm,l as dm,m as fm,n as mm,o as gm,C as pm,r as Po,S as _m}from"./firebase-auth-BSQ1sEJx.js";var lc=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ce=new om("@firebase/firestore");function xn(){return Ce.logLevel}function Ay(r){Ce.setLogLevel(r)}function x(r,...t){if(Ce.logLevel<=ie.DEBUG){const e=t.map(ea);Ce.debug(`Firestore (${sr}): ${r}`,...e)}}function mt(r,...t){if(Ce.logLevel<=ie.ERROR){const e=t.map(ea);Ce.error(`Firestore (${sr}): ${r}`,...e)}}function Gt(r,...t){if(Ce.logLevel<=ie.WARN){const e=t.map(ea);Ce.warn(`Firestore (${sr}): ${r}`,...e)}}function ea(r){if(typeof r=="string")return r;try{return(function(e){return JSON.stringify(e)})(r)}catch{return r}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function O(r,t,e){let n="Unexpected state";typeof t=="string"?n=t:e=t,$l(r,n,e)}function $l(r,t,e){let n=`FIRESTORE (${sr}) INTERNAL ASSERTION FAILED: ${t} (ID: ${r.toString(16)})`;if(e!==void 0)try{n+=" CONTEXT: "+JSON.stringify(e)}catch{n+=" CONTEXT: "+e}throw mt(n),new Error(n)}function L(r,t,e,n){let s="Unexpected state";typeof e=="string"?s=e:n=e,r||$l(t,s,n)}function vy(r,t){r||O(57014,t)}function M(r,t){return r}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class na{static newId(){const t="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",e=62*Math.floor(4.129032258064516);let n="";for(;n.length<20;){const s=Rm(40);for(let i=0;i<s.length;++i)n.length<20&&s[i]<e&&(n+=t.charAt(s[i]%62))}return n}}function z(r,t){return r<t?-1:r>t?1:0}function bo(r,t){const e=Math.min(r.length,t.length);for(let n=0;n<e;n++){const s=r.charAt(n),i=t.charAt(n);if(s!==i)return _o(s)===_o(i)?z(s,i):_o(s)?1:-1}return z(r.length,t.length)}const Pm=55296,Sm=57343;function _o(r){const t=r.charCodeAt(0);return t>=Pm&&t<=Sm}function Ln(r,t,e){return r.length===t.length&&r.every(((n,s)=>e(n,t[s])))}function Wl(r){return r+"\0"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ws(r,t){return[r,xt(t)]}function rh(r,t,e){return[r,xt(t),e]}const Lm={},jn="documentMutations",oi="remoteDocumentsV14",qm=["prefixPath","collectionGroup","readTime","documentId"],Hs="documentKeyIndex",Bm=["prefixPath","collectionGroup","documentId"],sh="collectionGroupIndex",Um=["collectionGroup","readTime","prefixPath","documentId"],Xr="remoteDocumentGlobal",Do="remoteDocumentGlobalKey",zn="targets",ih="queryTargetsIndex",jm=["canonicalId","targetId"],Gn="targetDocuments",zm=["targetId","path"],oa="documentTargetsIndex",Gm=["path","targetId"],ai="targetGlobalKey",sn="targetGlobal",Zr="collectionParents",Km=["collectionId","parent"],Kn="clientMetadata",$m="clientId",wi="bundles",Qm="bundleId",Ai="namedQueries",Wm="name",aa="indexConfiguration",Hm="indexId",No="collectionGroupIndex",Jm="collectionGroup",zr="indexState",Ym=["indexId","uid"],oh="sequenceNumberIndex",Xm=["uid","sequenceNumber"],Gr="indexEntries",Zm=["indexId","uid","arrayValue","directionalValue","orderedDocumentKey","documentKey"],ah="documentKeyIndex",tg=["indexId","uid","orderedDocumentKey"],vi="documentOverlays",eg=["userId","collectionPath","documentId"],ko="collectionPathOverlayIndex",ng=["userId","collectionPath","largestBatchId"],uh="collectionGroupOverlayIndex",rg=["userId","collectionGroup","largestBatchId"],ua="globals",sg="name",ch=[Yr,Qt,jn,Ye,zn,hs,sn,Gn,Kn,Xr,Zr,wi,Ai],ig=[...ch,vi],lh=[Yr,Qt,jn,oi,zn,hs,sn,Gn,Kn,Xr,Zr,wi,Ai,vi],hh=lh,ca=[...hh,aa,zr,Gr],og=ca,dh=[...ca,ua],ag=dh;/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Mo extends th{constructor(t,e){super(),this.le=t,this.currentSequenceNumber=e}}function Tt(r,t){const e=M(r);return te.O(e.le,t)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Sy(){return typeof atob<"u"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ga(r,t){if(r.useProto3Json){if(isNaN(t))return{doubleValue:"NaN"};if(t===1/0)return{doubleValue:"Infinity"};if(t===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:Jr(t)?"-0":t}}function Bh(r){return{integerValue:""+r}}function Uh(r,t){return nh(t)?Bh(t):ga(r,t)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ep{bt(t){return Tt(t,ua)}getSessionToken(t){return this.bt(t).get("sessionToken").next((e=>{const n=e==null?void 0:e.value;return n?ft.fromUint8Array(n):ft.EMPTY_BYTE_STRING}))}setSessionToken(t,e){return this.bt(t).put({name:"sessionToken",value:e.toUint8Array()})}}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Va{constructor(t,e,n,s){this.targetId=t,this.fromCache=e,this.Ts=n,this.Es=s}static Is(t,e){let n=G(),s=G();for(const i of e.docChanges)switch(i.type){case 0:n=n.add(i.doc.key);break;case 1:s=s.add(i.doc.key)}return new Va(t,e.fromCache,n,s)}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ks=null;function Jo(){return Ks===null?Ks=(function(){return 268435456+Math.round(2147483648*Math.random())})():Ks++,"0x"+Ks.toString(16)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Dy=-1;class st extends Is{constructor(t,e,n,s){super(t,e,n,s),this.type="firestore",this._queue=new Pl,this._persistenceKey=(s==null?void 0:s.name)||"[DEFAULT]"}async _terminate(){if(this._firestoreClient){const t=this._firestoreClient.terminate();this._queue=new Pl(t),this._firestoreClient=void 0,await t}}}function Ny(r,t,e){e||(e=es);const n=Fl(r,"firestore");if(n.isInitialized(e)){const s=n.getImmediate({identifier:e}),i=n.getOptions(e);if(cs(i,t))return s;throw new b(P.FAILED_PRECONDITION,"initializeFirestore() has already been called with different options. To avoid this error, call initializeFirestore() with the same options as when it was originally called, or call getFirestore() to return the already initialized instance.")}if(t.cacheSizeBytes!==void 0&&t.localCache!==void 0)throw new b(P.INVALID_ARGUMENT,"cache and cacheSizeBytes cannot be specified at the same time as cacheSizeBytes willbe deprecated. Instead, specify the cache size in the cache object");if(t.cacheSizeBytes!==void 0&&t.cacheSizeBytes!==-1&&t.cacheSizeBytes<Td)throw new b(P.INVALID_ARGUMENT,"cacheSizeBytes must be at least 1048576");return t.host&&ta(t.host)&&Ol(t.host),n.initialize({options:t,instanceIdentifier:e})}function ky(r,t){const e=typeof r=="object"?r:dm(),n=typeof r=="string"?r:t||es,s=Fl(e,"firestore").getImmediate({identifier:n});if(!s._initialized){const i=fm("firestore");i&&H_(s,...i)}return s}function ht(r){if(r._terminated)throw new b(P.FAILED_PRECONDITION,"The client has already been terminated.");return r._firestoreClient||df(r),r._firestoreClient}function df(r){var n,s,i,a;const t=r._freezeSettings(),e=W_(r._databaseId,((n=r._app)==null?void 0:n.options.appId)||"",r._persistenceKey,(s=r._app)==null?void 0:s.options.apiKey,t);r._componentsProvider||(i=t.localCache)!=null&&i._offlineComponentProvider&&((a=t.localCache)!=null&&a._onlineComponentProvider)&&(r._componentsProvider={_offline:t.localCache._offlineComponentProvider,_online:t.localCache._onlineComponentProvider}),r._firestoreClient=new D_(r._authCredentials,r._appCheckCredentials,r._queue,e,r._componentsProvider&&(function(c){const h=c==null?void 0:c._online.build();return{_offline:c==null?void 0:c._offline.build(h),_online:h}})(r._componentsProvider))}function My(r,t){Gt("enableIndexedDbPersistence() will be deprecated in the future, you can use `FirestoreSettings.cache` instead.");const e=r._freezeSettings();return ff(r,Me.provider,{build:n=>new Qa(n,e.cacheSizeBytes,t==null?void 0:t.forceOwnership)}),Promise.resolve()}async function Fy(r){Gt("enableMultiTabIndexedDbPersistence() will be deprecated in the future, you can use `FirestoreSettings.cache` instead.");const t=r._freezeSettings();ff(r,Me.provider,{build:e=>new ef(e,t.cacheSizeBytes)})}function ff(r,t,e){if((r=Q(r,st))._firestoreClient||r._terminated)throw new b(P.FAILED_PRECONDITION,"Firestore has already been started and persistence can no longer be enabled. You can only enable persistence before calling any other methods on a Firestore object.");if(r._componentsProvider||r._getSettings().localCache)throw new b(P.FAILED_PRECONDITION,"SDK cache is already specified.");r._componentsProvider={_online:t,_offline:e},df(r)}function Oy(r){if(r._initialized&&!r._terminated)throw new b(P.FAILED_PRECONDITION,"Persistence can only be cleared before a Firestore instance is initialized or after it is terminated.");const t=new Rt;return r._queue.enqueueAndForgetEvenWhileRestricted((async()=>{try{await(async function(n){if(!te.v())return Promise.resolve();const s=n+Pd;await te.delete(s)})(Sa(r._databaseId,r._persistenceKey)),t.resolve()}catch(e){t.reject(e)}})),t.promise}function Ly(r){return(function(e){const n=new Rt;return e.asyncQueue.enqueueAndForget((async()=>p_(await Ha(e),n))),n.promise})(ht(r=Q(r,st)))}function qy(r){return N_(ht(r=Q(r,st)))}function By(r){return k_(ht(r=Q(r,st)))}function Uy(r){return mm(r.app,"firestore",r._databaseId.database),r._delete()}function Vl(r,t){const e=ht(r=Q(r,st)),n=new Y_;return j_(e,r._databaseId,t,n),n}function X_(r,t){return z_(ht(r=Q(r,st)),t).then((e=>e?new Pt(r,null,e.query):null))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class fr{constructor(...t){for(let e=0;e<t.length;++e)if(t[e].length===0)throw new b(P.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new ct(t)}isEqual(t){return this._internalPath.isEqual(t._internalPath)}}function jy(){return new fr(Co)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zy(){return new Ts("deleteField")}function Gy(){return new Ja("serverTimestamp")}function Ky(...r){return new Ya("arrayUnion",r)}function $y(...r){return new Xa("arrayRemove",r)}function Qy(r){return new Za("increment",r)}function Wy(r){return new $t(r)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function uI(r){return new as("sum",ce("sum",r))}function cI(r){return new as("avg",ce("average",r))}function iy(){return new as("count")}function lI(r,t){var e,n;return r instanceof as&&t instanceof as&&r.aggregateType===t.aggregateType&&((e=r._internalFieldPath)==null?void 0:e.canonicalString())===((n=t._internalFieldPath)==null?void 0:n.canonicalString())}function hI(r,t){return hf(r.query,t.query)&&cs(r.data(),t.data())}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function dI(r){return oy(r,{count:iy()})}function oy(r,t){const e=Q(r.firestore,st),n=ht(e),s=fh(t,((i,a)=>new Wh(a,i.aggregateType,i._internalFieldPath)));return L_(n,r._query,s).then((i=>(function(u,c,h){const f=new je(u);return new ry(c,f,h)})(e,r,i)))}class ay{constructor(t){this.kind="memory",this._onlineComponentProvider=Me.provider,this._offlineComponentProvider=t!=null&&t.garbageCollector?t.garbageCollector._offlineComponentProvider:{build:()=>new $a(void 0)}}toJSON(){return{kind:this.kind}}}class uy{constructor(t){let e;this.kind="persistent",t!=null&&t.tabManager?(t.tabManager._initialize(t),e=t.tabManager):(e=fy(void 0),e._initialize(t)),this._onlineComponentProvider=e._onlineComponentProvider,this._offlineComponentProvider=e._offlineComponentProvider}toJSON(){return{kind:this.kind}}}class cy{constructor(){this.kind="memoryEager",this._offlineComponentProvider=nr.provider}toJSON(){return{kind:this.kind}}}class ly{constructor(t){this.kind="memoryLru",this._offlineComponentProvider={build:()=>new $a(t)}}toJSON(){return{kind:this.kind}}}function fI(){return new cy}function mI(r){return new ly(r==null?void 0:r.cacheSizeBytes)}function gI(r){return new ay(r)}function pI(r){return new uy(r)}class hy{constructor(t){this.forceOwnership=t,this.kind="persistentSingleTab"}toJSON(){return{kind:this.kind}}_initialize(t){this._onlineComponentProvider=Me.provider,this._offlineComponentProvider={build:e=>new Qa(e,t==null?void 0:t.cacheSizeBytes,this.forceOwnership)}}}class dy{constructor(){this.kind="PersistentMultipleTab"}toJSON(){return{kind:this.kind}}_initialize(t){this._onlineComponentProvider=Me.provider,this._offlineComponentProvider={build:e=>new ef(e,t==null?void 0:t.cacheSizeBytes)}}}function fy(r){return new hy(r==null?void 0:r.forceOwnership)}function _I(){return new dy}/**
 * @license
 * Copyright 2025 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _y{constructor(t,e){this._firestore=t,this._transaction=e,this._dataReader=Tn(t)}get(t){const e=Se(t,this._firestore),n=new ou(this._firestore);return this._transaction.lookup([e._key]).then((s=>{if(!s||s.length!==1)return O(24041);const i=s[0];if(i.isFoundDocument())return new us(this._firestore,n,i.key,i,e.converter);if(i.isNoDocument())return new us(this._firestore,n,e._key,null,e.converter);throw O(18433,{doc:i})}))}set(t,e,n){const s=Se(t,this._firestore),i=Ki(s.converter,e,n),a=Ui(this._dataReader,"Transaction.set",s._key,i,s.converter!==null,n);return this._transaction.set(s._key,a),this}update(t,e,n,...s){const i=Se(t,this._firestore);let a;return a=typeof(e=It(e))=="string"||e instanceof fr?eu(this._dataReader,"Transaction.update",i._key,e,n,s):tu(this._dataReader,"Transaction.update",i._key,e),this._transaction.update(i._key,a),this}delete(t){const e=Se(t,this._firestore);return this._transaction.delete(e._key),this}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class yy extends _y{constructor(t,e){super(t,e),this._firestore=t}get(t){const e=Se(t,this._firestore),n=new je(this._firestore);return super.get(t).then((s=>new jt(this._firestore,n,e._key,s._document,new Pe(!1,!1),e.converter)))}}function EI(r,t,e){r=Q(r,st);const n={...gy,...e};(function(a){if(a.maxAttempts<1)throw new b(P.INVALID_ARGUMENT,"Max attempts must be at least 1")})(n);const s=ht(r);return U_(s,(i=>t(new yy(r,i))),n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function wI(r){r=Q(r,nt);const t=Q(r.firestore,st),e=ht(t);return of(e,r._key).then((n=>au(t,r,n)))}function AI(r){r=Q(r,nt);const t=Q(r.firestore,st),e=ht(t),n=new je(t);return F_(e,r._key).then((s=>new jt(t,n,r._key,s,new Pe(s!==null&&s.hasLocalMutations,!0),r.converter)))}function vI(r){r=Q(r,nt);const t=Q(r.firestore,st),e=ht(t);return of(e,r._key,{source:"server"}).then((n=>au(t,r,n)))}function RI(r){r=Q(r,Pt);const t=Q(r.firestore,st),e=ht(t),n=new je(t);return wf(r._query),af(e,r._query).then((s=>new zt(t,n,r,s)))}function PI(r){r=Q(r,Pt);const t=Q(r.firestore,st),e=ht(t),n=new je(t);return O_(e,r._query).then((s=>new zt(t,n,r,s)))}function SI(r){r=Q(r,Pt);const t=Q(r.firestore,st),e=ht(t),n=new je(t);return af(e,r._query,{source:"server"}).then((s=>new zt(t,n,r,s)))}function VI(r,t,e){r=Q(r,nt);const n=Q(r.firestore,st),s=Ki(r.converter,t,e),i=Tn(n);return As(n,[Ui(i,"setDoc",r._key,s,r.converter!==null,e).toMutation(r._key,lt.none())])}function bI(r,t,e,...n){r=Q(r,nt);const s=Q(r.firestore,st),i=Tn(s);let a;return a=typeof(t=It(t))=="string"||t instanceof fr?eu(i,"updateDoc",r._key,t,e,n):tu(i,"updateDoc",r._key,t),As(s,[a.toMutation(r._key,lt.exists(!0))])}function CI(r){return As(Q(r.firestore,st),[new ar(r._key,lt.none())])}function xI(r,t){const e=Q(r.firestore,st),n=J_(r),s=Ki(r.converter,t),i=Tn(r.firestore);return As(e,[Ui(i,"addDoc",n._key,s,r.converter!==null,{}).toMutation(n._key,lt.exists(!1))]).then((()=>n))}function Nl(r,...t){var h,f,m;r=It(r);let e={includeMetadataChanges:!1,source:"default"},n=0;typeof t[n]!="object"||On(t[n])||(e=t[n++]);const s={includeMetadataChanges:e.includeMetadataChanges,source:e.source};if(On(t[n])){const p=t[n];t[n]=(h=p.next)==null?void 0:h.bind(p),t[n+1]=(f=p.error)==null?void 0:f.bind(p),t[n+2]=(m=p.complete)==null?void 0:m.bind(p)}let i,a,u;if(r instanceof nt)a=Q(r.firestore,st),u=ir(r._key.path),i={next:p=>{t[n]&&t[n](au(a,r,p))},error:t[n+1],complete:t[n+2]};else{const p=Q(r,Pt);a=Q(p.firestore,st),u=p._query;const v=new je(a);i={next:C=>{t[n]&&t[n](new zt(a,v,p,C))},error:t[n+1],complete:t[n+2]},wf(r._query)}const c=ht(a);return M_(c,u,s,i)}function DI(r,t,...e){const n=It(r),s=(function(c){const h={bundle:"",bundleName:"",bundleSource:""},f=["bundle","bundleName","bundleSource"];for(const m of f){if(!(m in c)){h.error=`snapshotJson missing required field: ${m}`;break}const p=c[m];if(typeof p!="string"){h.error=`snapshotJson field '${m}' must be a string.`;break}if(p.length===0){h.error=`snapshotJson field '${m}' cannot be an empty string.`;break}m==="bundle"?h.bundle=p:m==="bundleName"?h.bundleName=p:m==="bundleSource"&&(h.bundleSource=p)}return h})(t);if(s.error)throw new b(P.INVALID_ARGUMENT,s.error);let i,a=0;if(typeof e[a]!="object"||On(e[a])||(i=e[a++]),s.bundleSource==="QuerySnapshot"){let u=null;if(typeof e[a]=="object"&&On(e[a])){const c=e[a++];u={next:c.next,error:c.error,complete:c.complete}}else u={next:e[a++],error:e[a++],complete:e[a++]};return(function(h,f,m,p,v){let C,N=!1;return Vl(h,f.bundle).then((()=>X_(h,f.bundleName))).then((q=>{q&&!N&&(v&&q.withConverter(v),C=Nl(q,m||{},p))})).catch((q=>(p.error&&p.error(q),()=>{}))),()=>{N||(N=!0,C&&C())}})(n,s,i,u,e[a])}if(s.bundleSource==="DocumentSnapshot"){let u=null;if(typeof e[a]=="object"&&On(e[a])){const c=e[a++];u={next:c.next,error:c.error,complete:c.complete}}else u={next:e[a++],error:e[a++],complete:e[a++]};return(function(h,f,m,p,v){let C,N=!1;return Vl(h,f.bundle).then((()=>{if(!N){const q=new nt(h,v||null,k.fromPath(f.bundleName));C=Nl(q,m||{},p)}})).catch((q=>(p.error&&p.error(q),()=>{}))),()=>{N||(N=!0,C&&C())}})(n,s,i,u,e[a])}throw new b(P.INVALID_ARGUMENT,`unsupported bundle source: ${s.bundleSource}`)}function NI(r,t){r=Q(r,st);const e=ht(r),n=On(t)?t:{next:t};return B_(e,n)}function As(r,t){const e=ht(r);return q_(e,t)}function au(r,t,e){const n=e.docs.get(t._key),s=new je(r);return new jt(r,s,t._key,n,new Pe(e.hasPendingWrites,e.fromCache),t.converter)}function kI(r){return r=Q(r,st),ht(r),new py(r,(t=>As(r,t)))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function MI(r,t){r=Q(r,st);const e=ht(r);if(!e._uninitializedComponentsProvider||e._uninitializedComponentsProvider._offline.kind==="memory")return Gt("Cannot enable indexes when persistence is disabled"),Promise.resolve();const n=(function(i){const a=typeof i=="string"?(function(h){try{return JSON.parse(h)}catch(f){throw new b(P.INVALID_ARGUMENT,"Failed to parse JSON: "+(f==null?void 0:f.message))}})(i):i,u=[];if(Array.isArray(a.indexes))for(const c of a.indexes){const h=kl(c,"collectionGroup"),f=[];if(Array.isArray(c.fields))for(const m of c.fields){const p=kl(m,"fieldPath"),v=ru("setIndexConfiguration",p);m.arrayConfig==="CONTAINS"?f.push(new rn(v,2)):m.order==="ASCENDING"?f.push(new rn(v,0)):m.order==="DESCENDING"&&f.push(new rn(v,1))}u.push(new Bn(Bn.UNKNOWN_ID,h,f,Un.empty()))}return u})(t);return G_(e,n)}function kl(r,t){if(typeof r[t]!="string")throw new b(P.INVALID_ARGUMENT,"Missing string value for: "+t);return r[t]}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Iy{constructor(t){this._firestore=t,this.type="PersistentCacheIndexManager"}}function FI(r){var s;r=Q(r,st);const t=Ml.get(r);if(t)return t;if(((s=ht(r)._uninitializedComponentsProvider)==null?void 0:s._offline.kind)!=="persistent")return null;const n=new Iy(r);return Ml.set(r,n),n}function OI(r){Sf(r,!0)}function LI(r){Sf(r,!1)}function qI(r){const t=ht(r._firestore);$_(t).then((e=>x("deleting all persistent cache indexes succeeded"))).catch((e=>Gt("deleting all persistent cache indexes failed",e)))}function Sf(r,t){const e=ht(r._firestore);K_(e,t).then((n=>x(`setting persistent cache index auto creation isEnabled=${t} succeeded`))).catch((n=>Gt(`setting persistent cache index auto creation isEnabled=${t} failed`,n)))}const Ml=new WeakMap;/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class BI{constructor(){throw new Error("instances of this class should not be created")}static onExistenceFilterMismatch(t){return uu.instance.onExistenceFilterMismatch(t)}}class uu{constructor(){this.t=new Map}static get instance(){return $s||($s=new uu,Og($s)),$s}o(t){this.t.forEach((e=>e(t)))}onExistenceFilterMismatch(t){const e=Symbol(),n=this.t;return n.set(e,t),()=>n.delete(e)}}let $s=null;(function(t,e=!0){ym(_m),gm(new pm("firestore",((n,{instanceIdentifier:s,options:i})=>{const a=n.getProvider("app").getImmediate(),u=new st(new Em(n.getProvider("auth-internal")),new vm(a,n.getProvider("app-check-internal")),lg(a,s),a);return i={useFetchStreams:e,...i},u._setSettings(i),u}),"PUBLIC").setMultipleInstances(!0)),Po(bl,Cl,t),Po(bl,Cl,"esm2020")})();var Ty="firebase",Ey="12.11.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Po(Ty,Ey,"app");export{Ef as AbstractUserDataWriter,as as AggregateField,ry as AggregateQuerySnapshot,Ut as Bytes,Dy as CACHE_SIZE_UNLIMITED,ne as CollectionReference,nt as DocumentReference,jt as DocumentSnapshot,fr as FieldPath,In as FieldValue,st as Firestore,b as FirestoreError,re as GeoPoint,Y_ as LoadBundleTask,Iy as PersistentCacheIndexManager,Pt as Query,mr as QueryCompositeFilterConstraint,Es as QueryConstraint,ri as QueryDocumentSnapshot,Gi as QueryEndAtConstraint,ws as QueryFieldFilterConstraint,ji as QueryLimitConstraint,iu as QueryOrderByConstraint,zt as QuerySnapshot,zi as QueryStartAtConstraint,Pe as SnapshotMetadata,Z as Timestamp,yy as Transaction,$t as VectorValue,py as WriteBatch,na as _AutoId,ft as _ByteString,an as _DatabaseId,k as _DocumentKey,Ry as _EmptyAppCheckTokenProvider,Im as _EmptyAuthCredentialsProvider,ct as _FieldPath,BI as _TestingHooks,Q as _cast,vy as _debugAssert,Jy as _internalAggregationQueryToProtoRunAggregationQueryRequest,Hy as _internalQueryToProtoQueryTarget,Sy as _isBase64Available,Gt as _logWarn,bm as _validateIsNotUsedTogether,xI as addDoc,lI as aggregateFieldEqual,hI as aggregateQuerySnapshotEqual,tI as and,$y as arrayRemove,Ky as arrayUnion,cI as average,Oy as clearIndexedDbPersistence,by as collection,Cy as collectionGroup,H_ as connectFirestoreEmulator,iy as count,qI as deleteAllPersistentCacheIndexes,CI as deleteDoc,zy as deleteField,By as disableNetwork,LI as disablePersistentCacheIndexAutoCreation,J_ as doc,jy as documentId,yI as documentSnapshotFromJSON,My as enableIndexedDbPersistence,Fy as enableMultiTabIndexedDbPersistence,qy as enableNetwork,OI as enablePersistentCacheIndexAutoCreation,aI as endAt,oI as endBefore,ht as ensureFirestoreConfigured,As as executeWrite,oy as getAggregateFromServer,dI as getCountFromServer,wI as getDoc,AI as getDocFromCache,vI as getDocFromServer,RI as getDocs,PI as getDocsFromCache,SI as getDocsFromServer,ky as getFirestore,FI as getPersistentCacheIndexManager,Qy as increment,Ny as initializeFirestore,nI as limit,rI as limitToLast,Vl as loadBundle,fI as memoryEagerGarbageCollector,gI as memoryLocalCache,mI as memoryLruGarbageCollector,X_ as namedQuery,Nl as onSnapshot,DI as onSnapshotResume,NI as onSnapshotsInSync,Zy as or,eI as orderBy,pI as persistentLocalCache,_I as persistentMultipleTabManager,fy as persistentSingleTabManager,Yy as query,hf as queryEqual,II as querySnapshotFromJSON,xy as refEqual,EI as runTransaction,Gy as serverTimestamp,VI as setDoc,MI as setIndexConfiguration,Ay as setLogLevel,TI as snapshotEqual,iI as startAfter,sI as startAt,uI as sum,Uy as terminate,bI as updateDoc,Wy as vector,Ly as waitForPendingWrites,Xy as where,kI as writeBatch};
